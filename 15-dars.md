...
`df` buyrug'i kompyuterdagi mavjud xotira hajmini ko'rsatadi. U fayl tizimi, hajmi, mavjud xotira (foizda) va qayerda o'rnatilganini ko'rsatadi. `-h` (human) optsiyasi odamlar o'qishi uchun qulay tarzda ekranga chiqaradi.
