...
Siz `cd` (change-directory) buyrug'i bilan tanish bo'lishingiz mumkin, chunki Windows, MacOS, KolibriOS va boshqa operatsion tizimlar bu buyruqni to'liq qo'llab-quvvatlaydi. `cd` orqali boshqa kataloglarga "sakrash" mumkin. Misol uchun, siz fayl yaratdingiz va fayl terminal ochilgan katalogda saqlanadi. Masalan, agar fayl `/home/khumoyun/experiments/` katalogida saqlangan bo'lsa:
...
Endi faylni "papka" ichida yaratmoqchi bo'lsangiz, buni ikki xil usulda bajarishingiz mumkin:
...
> **P.S.** O'sha nuqtalar aslida yashirin papkalar hisoblanadi. Buni `ls -a` buyrug'idan aniqlash mumkin.
