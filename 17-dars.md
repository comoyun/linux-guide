...
sort: 17
---
Windows yoki OSX bilan ancha payt shug'ullanib Linux-ga birinchi qadam qo'yganingizda siz har kuni foydalanadigan MS Office, Adobe va AutoCad kabi dasturlar Linux uchun ishlab chiqilmaganini payqaysiz. Lekin, albatta bularga alternativ variantlar borligini ham unutmang. 
...
- [LibreOffice](https://www.libreoffice.org/download/download-libreoffice/) - bu bepul va ochiq manbali ofis dasturlari to'plami
...
Sinab ko'rgan ilovalarim ichiga VirtualBox, VMWare, Qemu, VirtManager, GNOME Boxes kiradi. Maslahat beraman: GNOME Boxes yoki VirtManager, chunki undagi virtual mashinalar yadro bilan to'g'ridan-to'g'ri aloqa qilgani sababli sezilarli darajada tezroq ishlaydi va bu ilovalar faqat Linux uchun ishlab chiqilgan.

Terminalda virtual mashina yaratishni hoxlasangiz: 
