...
Terminaldagi eng asosiy hususiyatlardan biri "***expansion***" ya'ni ***yoyish*** hisoblanadi. Bu nimaligini misollarda ko'rib chiqamiz:
...
>`$()` o'rniga `` belgilarini  ishlatishingiz mumkin. Misol:
...
Tushunarli, lekin menga bularni nima foydasi bor desangiz - foydasi ko'p. Bu faqat `echo` ichida emas, balki barcha buyruqlar bilan ishlay oladi. Misol uchun yoyishni `touch` yoki `rm` kabi buyruqlar bilan ishlatib uzoq va mashaqqatli jarayonlarni ossonlashtira olasiz.
...
$ cat > matn.txt
Hey!
cat mening eng sevimli kommandalarimdan biri.
```

**CTRL + C** yoki **CTRL + D** klavishlarini bosib chiqib keting va faylga qanday yozilganini tekshirib ko'ring, albatta `cat` orqali.
